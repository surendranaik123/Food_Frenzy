        ...
        <header className="d-flex flex-wrap justify-content-between align-items-center py-3 ">
          ...
          <ul className={`nav nav-pills ${menuOpen ? "show" : ""}`}>
            <li className="nav-item">
              <a href="/home" className="nav-link-custom" aria-current="page">
                Home
              </a>
            </li>
            <li className="nav-item">
              <a href="/veg" className="nav-link-custom">
                Veg
              </a>
            </li>
            <li className="nav-item">
              <a href="/nonveg" className="nav-link-custom">
                Non-Veg
              </a>
            </li>
            <li className="nav-item">
              <a href="/beve" className="nav-link-custom">
                Beverages
              </a>
            </li>
            <li className="nav-item">
              <a href="/offers" className="nav-link-custom">
                Offers
              </a>
            </li>
            <li className="nav-item">
            ...
            <li
              className="nav-item"
              style={{ display: "flex", marginLeft: "140px" }}
            >
              <img
                src={personlogo}
                alt="personlogo"
              ...
              <NavDropdown style={{ marginTop: "0px" }}>
                ...
                <hr />
                <DropdownItem className="nav-link-custom">Setting</DropdownItem>
                <hr />
